				...
				<div class="col-lg-9 offset-lg-2 text-center">
					<div class="hero-text">
						<div class="hero-text-tablecell">
							<p class="subtitle">Modern & Convenient</p>
							<h1>Smart Technology Devices</h1>
							<div class="hero-btns">
								<a href="{{url ('shop')}}" class="boxed-btn">Product Collection</a>
                	...
                	<div class="image">
                    	<div class="price-box">
                        	<div class="inner-price">
                                <span class="price">
                                    <strong>30%</strong> <br> off per product
                                </span>
                            </div>
                        </div>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-12">
					<div class="abt-text">
						...
						<h2>We are <span class="orange-text">Electro</span></h2>
